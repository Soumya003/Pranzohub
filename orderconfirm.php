    ...
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        <div class="site-wrapper" >
                        ...
                        <div class="container">
                            <div class="row" align="center">
                                <div class="col-xs-12 col-sm-12 col-lg-12 cursive">
                                    <h1 class="font-white">Order Confirmed</h1> 
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="page-wrapper">
                ...
                <!-- Cofirmation Section start -->
                <div class="confirmation-section">
                    <div class="container">
                        <div class="about-inner-section"> 
                            <div class="row">    
                                <div class="col-md-12 col-sm-12">        
                                    <h1 align="center"><i class="fa fa-check-circle text-success" aria-hidden="true"></i> </h1>
                                </div>
                                <div class="col-md-12 col-sm-12">  
                                    <h1 align="center">Your subscription has been confirmed</h1> 
                                </div>
                            </div>  
                            <br>
                            <div class="row">
                                <div class="col-md-5 col-sm-12">
                                    <h3 align="right"><a href="#" class="btn theme-btn-dash" style="font-weight: bold;">Go to Profile</a></h3>
                                </div>
                                <div class="col-md-2 col-sm-12">
                                    <h3 align="center">OR</h3>
                                </div>
                                <div class="col-md-5 col-sm-12">
                                    <h3 align="left"><a href="contact.php" class="btn theme-btn-dash" style="font-weight: bold;">Contact Us</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
