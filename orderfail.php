                        ...
                        <div class="container">
                            <div class="row" align="center">
                                <div class="col-xs-12 col-sm-12 col-lg-12 cursive">
                                    <h1 class="font-white">Order Failed</h1> 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="about-inner-section">               
                            <div class="row">    
                                <div class="col-md-12 col-sm-12">        
                                    <h1 align="center"><i class="fa fa-times-circle-o text-danger" aria-hidden="true"></i> </h1>
                                </div>
                                <div class="col-md-12 col-sm-12">  
                                    <h1 align="center">Your subscription confirmation has failed</h1> 
                                </div>
                            </div>  
                            <br>
                            <div class="row">
