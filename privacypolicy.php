                        ...
                        <div class="container">
                            <div class="row" align="center">
                                <div class="col-xs-12 col-sm-12 col-lg-12 cursive">
                                    <h1 class="font-white">Privacy Policy</h1> 
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <h3 align="left"><a href="contact.php" class="btn theme-btn-dash">Contact Us</a><br></h3>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                       <h3 align="right"><a href="registration.php" class="btn theme-btn-dash">Register Now</a></h3>
                                    </div>
                                </div>
                            </div>
                            <!-- /WHY? -->
