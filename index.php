...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
            ...
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <!-- Area Selector starts -->
                            <?php include 'modules/area-selector.php'; ?>
                        <!-- Area Selector ends -->
                    </div>
                    <!-- Start steps -->
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>356 restaurants matched your location: <span class="primary-color">Bhubaneswar, Odisha -</span> </span>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                <h5><a href="subscription.php">Veg Breakfast</a></h5>
                                <div class="product-name">Fried Chicken with cheese</div>
                                <div class="price-btn-block"> <span class="price">₹ 900/month</span> <a href="subscription.php" class="btn theme-btn-dash pull-right">Subscribe Now</a> </div>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                <h5><a href="subscription.php">Non Veg Breakfast</a></h5>
                                <div class="product-name">Fried Chicken with cheese</div>
                                <div class="price-btn-block"> <span class="price">₹ 900/month</span> <a href="subscription.php" class="btn theme-btn-dash pull-right">Subscribe Now</a> </div>
                            </div>
                            <div class="restaurant-block">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                <h5><a href="subscription.php">Smoothies</a></h5>
                                <div class="product-name">Fried Chicken with cheese</div>
                                <div class="price-btn-block"> <span class="price">₹ 300/month</span> <a href="subscription.php" class="btn theme-btn-dash pull-right">Subscribe Now</a> </div>
                            </div>
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="profile.html"> <img src="images/logo-small.jpg" alt="Restaurant logo" height="50" width="50" /></a>
        ...
        <!-- Featured restaurants starts -->
            <?php include 'modules/featured-restaurants.php'; ?>
...
<!-- Mirrored from codenpixel.com/demo/foodpicky/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 May 2018 04:51:54 GMT -->
</html>